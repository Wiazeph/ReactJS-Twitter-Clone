...
const More = () => {
  return (
    <Popover className="relative">
      <Popover.Button className="group block outline-none">
        <div className="p-3 rounded-full inline-flex items-center gap-5 menuGroupHover">
      ...
      <Popover.Panel className="w-[318px] rounded-xl absolute bottom-0 left-0 bg-black shadow-moreBox overflow-hidden">
        <button className="px-3 h-14 w-full outline-none inline-flex items-center gap-5 menuHover">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg
              viewBox="0 0 24 24"
              width={24}
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="text-[#eae8e7] h-[52px] w-full font-bold flex items-center justify-between px-4 menuHover">
              ...
              <Disclosure.Panel>
                <Link
                  to="/"
                  className="flex items-center px-3 h-11 gap-3 font-medium text-sm menuHover"
                >
                  <svg
                    viewBox="0 0 24 24"
                    width={18.75}
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="text-[#e7e9ea] h-[52px] w-full font-bold flex items-center justify-between px-4 menuHover">
                Profesyonel Araçlar
                <svg
                  viewBox="0 0 24 24"
                  width={18.75}
